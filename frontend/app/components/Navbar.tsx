...
export default function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-30 h-16 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800/60 flex items-center justify-between px-8">
            {/* Sol: Arama (placeholder) */}
